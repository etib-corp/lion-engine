    ...
    namespace Sound {
        ...
        class Device {
            public:
                 ...
                 */
                class SoundDeviceError : public IError {
                public:
                    /**
                     * @brief Constructs a SoundDeviceError object with the given error details.
                     * @param details The error details.
                     * @param help The help message for the error.
                     */
                    SoundDeviceError(const std::string &details, const std::string &help) : IError("Sound Device Error", details, help) {}
