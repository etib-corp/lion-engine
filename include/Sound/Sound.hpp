    ...
    namespace Sound {
        ...
        class Sound {
            public:
                 ...
                 */
                class SoundError : public LE::IError {
                public:
                    /**
                     * @brief Constructs a SoundError object with the given error details.
                     * @param details The error details.
                     */
                    SoundError(const std::string &details, const std::string &help) : IError("Sound Error", details, help) {}
